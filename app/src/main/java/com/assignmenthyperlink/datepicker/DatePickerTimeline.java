...
public class DatePickerTimeline extends LinearLayout {
    ...
    void init(AttributeSet attrs, int defStyleAttr) {
        ...
        timelineView.setDayTextColor(a.getColor(R.styleable.DatePickerTimeline_dayTextColor, getResources().getColor(R.color.blue_highlight)));
        timelineView.setDateTextColor(a.getColor(R.styleable.DatePickerTimeline_dateTextColor, getResources().getColor(R.color.blue_highlight)));
        timelineView.setMonthTextColor(a.getColor(R.styleable.DatePickerTimeline_monthTextColor, getResources().getColor(R.color.blue_highlight)));
        timelineView.setDisabledDateColor(a.getColor(R.styleable.DatePickerTimeline_disabledColor, getResources().getColor(R.color.gray_close)));
...
//        timelineView.setDayTextSize(a.getDimension(R.styleable.DatePickerTimeline_dayTextSize, getResources().getDimension(R.dimen.dayTextSize)));
    ...
    public void setActiveDate(Calendar date) {
        timelineView.setActiveDate(date, timelineView);
    }
