...
import com.assignmenthyperlink.datepicker.adapter.TimelineAdapter;
...
public class TimelineView extends RecyclerView {
     ...
     * @param timelineView
     */
    public void setActiveDate(Calendar activeDate, TimelineView timelineView) {
        try {
            ...
            if (position > 3) {
                timelineView.getLayoutManager().scrollToPosition(position - 3);
            } else {
                timelineView.getLayoutManager().scrollToPosition(position);
            }
