...
import com.assignmenthyperlink.databinding.DialogExceptionDialogBinding
...
//    var alertDialog: AlertDialog? = null
    ...
    fun show() {
        ...
        try {
            ...
            val binding = DataBindingUtil.inflate<DialogExceptionDialogBinding>(
            ...
            binding.root.findViewById<TextView>(R.id.tvNo).setOnClickListener {
//                alertDialog!!.dismiss()
                dialogButtonClick.onNegativeClick()
            }

            binding.root.findViewById<TextView>(R.id.tvYes).setOnClickListener {
//                alertDialog!!.dismiss()
